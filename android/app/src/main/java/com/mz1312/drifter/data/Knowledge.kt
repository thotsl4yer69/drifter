...
object Knowledge {
    ...
    private val DOCS: Map<String, ServiceDoc> = listOf(
        ...
        ServiceDoc("drifter-hotspot", "Hotspot", "MZ1312_DRIFTER rescue AP", ServiceCategory.INFRA,
            remediation = listOf("RESCUE-ONLY: disabled by design — drifter-autoconnect raises it after ~90s when no known Wi-Fi is found.", "Manual: sudo nmcli con up MZ1312_DRIFTER (do NOT systemctl enable it)")),
