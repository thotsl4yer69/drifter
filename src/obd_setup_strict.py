...
def cmd_test(args) -> int:
    result = base.probe(base._configured_cfg())
...
def cmd_setup(args) -> int:
    """Run normal discovery, then require an independent final ECU proof.
